...
public class TaksongService {
 ...
 public SuseVO suvoselect(String su_idx) {
  SuseVO suvo = mapper.suvoselect(su_idx);
  return suvo;
 }
 ...
 public int serviceinyong(String s_idx) {
  int cnt = 0;
  cnt = mapper.serviceinyong(s_idx);
  return cnt;
 }

 public int serviceexit(String s_idx) {
  int cnt = 0;
  cnt = mapper.serviceexit(s_idx);
  return cnt;
 }
