...
public class Admin_review_paging {
    ...
    public Admin_review_paging() {
    };

    public Admin_review_paging(int numPerpage, int pagePerBlock) {
        this.numPerPage = numPerpage;
        this.pagePerBlock = pagePerBlock;
    }

    // 페이징에 필요한 HTML코드를 생성해 주는 생성자
    public Admin_review_paging(int nowPage, int totalRecord, int numPerPage, int pagePerBlock, String searchType,
            String searchValue) {
        ...
        if (isPrePage) { // 이전 기능이 적용되는 상황
            sb.append("<li><a href='/admin/review?cPage=");
