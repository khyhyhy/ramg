    ...
    <header style="margin-bottom: 0.0rem!important;"
     ...
     <div class="dropdown">
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
       <li>
        <a href="/fmap2/" style="font-family: 'GoryeongStrawberry';" class="nav-link px-2 link-secondary text-white">충전소 찾기</a>
       </li>
       <li>
       ...
       <li>
        <a href="#" style="font-family: 'GoryeongStrawberry';" class="nav-link px-2 link-secondary text-white" data-bs-toggle="dropdown">고객센터</a>
        <ul class="dropdown-menu">
       ...
       <li>
        <a href="#" style="font-family: 'GoryeongStrawberry';" class="nav-link px-2 link-secondary text-white" data-bs-toggle="dropdown">마이 페이지</a>
        <ul class="dropdown-menu">
