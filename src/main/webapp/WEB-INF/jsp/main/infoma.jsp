            ...
            <div class="container text-center">
                <div class="row row-cols-2">
                    <div class="col 1" style="padding: 0;">
                        <img src="../images/car_tak.png" alt="충전소 이미지" style="max-width: 650px;">
                    </div>
                    <div class="col 2" style="background-color: #848CB5;">
                        <h3 class="mt-5" style="text-align: left;">탁송 서비스</h3>
                        <p style="text-align: left;">
                            이 서비스를 이용하면 고객은 충전이 필요한 위치를 지정할 수 있습니다.<br/>
                            고객은 충전량을 설정하여 충전을 요청할 수 있습니다.<br/>
                            람쥐썬더 충전소는 충전이 완료된 후에 충전된 차량을 고객이 원하는 위치로 탁송해줍니다.<br/>
                            이를 통해 고객은 원하는 위치에서 편리하게 차량을 충전할 수 있습니다.
                        </p>
                        <a href="/taksong/">서비스 이용하기</a>
                    </div>
                    <div class="col 3" style="background-color: #C6D6F7;">
                        <h3 class="mt-5" style="text-align: left;">이동식 서비스</h3>
                        <p style="text-align: left;">
                            이 서비스를 이용하면 고객은 원하는 위치에서 기다리면 됩니다.<br/>
                            고객이 특정 장소에서 기다리면 람쥐썬더 충전소의 기사가 충전차량을 운전하여 이동합니다.<br/>
                            충전차량이 고객의 위치로 이동하여 충전 서비스를 제공합니다.<br/>
                            이를 통해 고객은 이동하지 않고도 바로 차량을 충전할 수 있으며, 편의성이 크게 향상됩니다.
                        </p>
                        <a href="/edongsik/">서비스 이용하기</a>
                    </div>
                    <div class="col 4" style="padding: 0;">
                        <img src="../images/car_edon.png" alt="충전소 이미지" style="max-width: 620px;">
                    </div>
                </div>
