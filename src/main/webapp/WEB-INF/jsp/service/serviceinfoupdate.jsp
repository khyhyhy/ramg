<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
 <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
      ...
      <div class="accordion accordion-flush" id="accordionFlushExample">
       <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingOne">
         <button id="onbody2" class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
       ...
       <div class="input-group input-group-sm mb-3">
        ...
        <div>
         <button id="map2col" style="display: none;" class="btn btn-primary" type="button" data-bs-toggle="collapse"
          data-bs-target="#mapcol" onclick="map2init()" readonly>
         </button>
        </div>
        ...
        <input class="btn btn-outline-secondary" type="text" id="e_addr" name="e_addr" readonly onclick="esearch(this)">
        <div class="input-group mb-3">
  ...
  <script>
   ...
   function onbody2() {
    document.getElementById("onbody2").click();
   ...
   function map3init() {
    var mapContainer = document.getElementById('map3'), // 지도를 표시할 div 
     mapOption = {
      center: new kakao.maps.LatLng("${ suvo.su_val4 }", " ${ suvo.su_val3 }"), // 지도의 중심좌표
      level: 3 // 지도의 확대 레벨
     };

    map3 = new kakao.maps.Map(mapContainer, mapOption); // 지도를 생성합니다
    geocoder = new kakao.maps.services.Geocoder();
    var markerPosition = new kakao.maps.LatLng("${ suvo.su_val4 }", " ${ suvo.su_val3 }");
